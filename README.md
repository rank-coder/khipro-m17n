...
## পরিচিতি
ক্ষিপ্র কোনো ফোনেটিক লেআউট নয়। এটি একটি কম্পোজিশনাল লেআউট। অর্থাৎ, alt কিংবা shift চাপার পরিবর্তে কোনো মডিফায়ার কি (modifier key) ব্যবহার করে 'ত' -কে 'ট', 'ক' -কে 'ক্ষ' বানানোর মতো অপারেশন করা যাবে। আরেকটি মডিফায়ার, স্লাইসার (slicer) ব্যবহার করে যুক্তবর্ণ ভাঙা, অর্থাৎ, 'ক্ত' -কে ভেঙে 'কত' করে ফেলা যাবে।
...
কম্পোজিশনাল টাইপিং মেথড কোনো ফোনেটিক পদ্ধতি না হলেও সেটার সাথে কিছুটা মিল রয়েছে। এ সম্পর্কে জানতে ক্ষিপ্র-র কুইকস্টার্ট গাইডটি দেখুন
