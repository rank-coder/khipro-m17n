...
## পরিচিতি
বাংলা ফোনেটিক টাইপিংয়ের জন্য অভ্র, ইত্যাদি জনপ্রিয় হলেও, বারবার Shift চাপা এবং কিছু key দূরে থাকার কারণে (যেমন:` ঁ` এর জন্য `^` চাপতে হয়) লেখার গতি ও ফ্লো নষ্ট হয়। ফলে একটা সীমার পর গতি আরও বাড়ানো অসম্ভব হয়ে যায়।
...
এ সব দূর করতে ক্ষিপ্রটিম নিয়ে এসেছে ‘ক্ষিপ্র’ কনসেপ্ট যা লোয়ারকেস ইনপুটভিত্তিক একটি বাংলা কিবো‍র্ড লেআউট।
...
ক্ষিপ্রতে কারচিহ্নকে ফোর্স করে স্বরবর্ণ বানানো, কিংবা স্বরবর্ণ কে ফোর্স করে কারচিহ্ন বানানো মাত্র একটা বাটন প্রেস করে করা সম্ভব। এরকম আরো বেশকিছু ফিচার রয়েছে।
